  ...
  if (V != NULL)
    {
      ...
      cout << "Elem: " << V->Elem << " Height: " << V->Height << " Balance: " << V->Balance << endl;
...
void BST::climbUp(Vertex *V)
{
  ...
  cout << "Start climbing tree to adjust heights..." << endl;

  //if V is leaf, go to parent
